        ...
        <div className="space-y-6">
          <div className="bg-gradient-to-br from-blue-50 to-purple-50 dark:from-blue-950/20 dark:to-purple-950/20 rounded-2xl p-6 border border-blue-100 dark:border-blue-900/30">
            ...
            <p className="text-gray-600 dark:text-gray-400 mb-6 leading-relaxed">
              Estou sempre aberto a conversar sobre novos projetos, oportunidades interessantes ou apenas trocar ideias sobre tecnologia.
            </p>
            ...
            <div className="flex flex-wrap gap-4">
              {socialLinks.map(link => (
                <a
                  ...
                  className={`flex items-center gap-3 px-4 py-3 bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 text-gray-600 dark:text-gray-400 transition-all duration-200 hover:scale-105 hover:shadow-md ${link.color}`}
                >
                  {link.icon}
